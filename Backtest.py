...
#Adress= "0xc31e54c7a869b9fcbecc14363cf510d1c41fa443" # ETH/USDC Arbitrum
#Adress= "0xc6962004f452be9203591991d15f6b388e09e8d0" # ETH/USDC Arbitrum

#startfrom= 1688184000   #(2023-07-01 12:00:00 GMT+8)


timeString = "2021-07-01 00:00:00" # 時間格式為字串
struct_time = time.strptime(timeString, "%Y-%m-%d %H:%M:%S") # 轉成時間元組
startfrom = int(time.mktime(struct_time)) # 轉成時間戳
